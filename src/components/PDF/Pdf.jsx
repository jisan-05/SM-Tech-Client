      ...
      <Page size="A4" orientation="landscape" style={styles.page}>
        <View style={styles.logoContainer}>
          ...
          <Text style={styles.reportInfo}>
            SM TECH STUDENT REPORT | Generated on: {currentDate} | Total
        ...
        <View style={styles.table}>
          {/* Table Header */}
          <View style={[styles.tableRow, styles.tableHeader]}>
            <Text style={[styles.tableCol, styles.colName]}>Student Name</Text>
            ...
            <Text style={[styles.tableCol, styles.colDob]}>DOB</Text>
            <Text style={[styles.tableCol, styles.colNid]}>NID/BC No.</Text>
            <Text style={[styles.tableCol, styles.colCourse]}>Course</Text>
            <Text style={[styles.tableCol, styles.colEnroll]}>Enrolled</Text>
            <Text style={[styles.tableCol, styles.colComplete]}>Completed</Text>
            <Text style={[styles.tableCol, styles.colStatus]}>Status</Text>
          </View>
          ...
          {students.map((student, index) => (
            <View style={styles.tableRow} key={index}>
              ...
              <Text style={[styles.tableCol, styles.colComplete]}>
                {new Date(student.course_complete_date).toLocaleDateString()}
              </Text>
              <Text
                style={[
                  styles.tableCol,
...
const PdfGenerator = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
            ...
            <>
              <div className="mb-6 text-center">
                ...
                <p className="text-gray-600 mb-2">
                  Ready to generate PDF report for {students.length} students
                </p>
                <p className="text-sm text-gray-500">
                  Includes all student information in a printable format
                </p>
              </div>
      ...
      <Link className="z-0 text-3xl">Hello</Link>
    </div>
  );
};
