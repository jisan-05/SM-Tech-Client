...
const FeaturedCourses = () => {
    ...
    const handleResize = () => {
        ...
        if (width < 640) {
            ...
            // Changed to 1024 to better target tablets
            setVisibleCount(2);
        } else {
            setVisibleCount(3);
        }
            ...
            <div className=" mx-auto mt-8 sm:mt-10 md:mt-12">
                <div className="flex items-center">
                    ...
                    <div className="flex-1 overflow-hidden px-2 sm:px-4">
                        <div
                            className={`flex justify-center gap-4 transition-transform duration-300 ease-in-out`}
                        >
                ...
                <div className="flex justify-center items-center mt-12">
                    <Link
                        to="/programs"
                        className="group relative btn btn-neutral bg-[#06998b] hover:bg-[#04897d] border-none rounded-3xl px-9 md:px-11 py-3.5 md:py-4.5 text-[17px] md:text-[19px] text-white overflow-hidden transition-all duration-300"
                    >
                        <span className="relative z-10 flex items-center">
                            See All Courses
                            <FaArrowRight className="ml-2 transition-all duration-300 transform translate-x-0 group-hover:translate-x-1" />
                        </span>
                        <span className="absolute inset-0 bg-[#04897d] transition-all duration-300 transform -translate-x-full group-hover:translate-x-0"></span>
                    </Link>
                </div>
            </div>
        </div>
